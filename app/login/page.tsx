    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
      <div className="w-full max-w-sm">
        ...
        <div className="card p-8 text-center">
          ...
          <p className="text-sm text-slate-500 mb-8">Coupon &amp; Reorder Management</p>

          <Suspense fallback={
            <button disabled className="w-full flex items-center justify-center gap-3 bg-white border border-slate-200 text-slate-400 font-medium text-sm rounded-lg px-4 py-3 shadow-sm">
